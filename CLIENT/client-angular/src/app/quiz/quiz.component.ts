...
export class QuizComponent implements OnInit{
  ...
  calcolaRisultato(): void {
    ...
    // Inizializziamo i punteggi per le diverse razze di cani e gatti
    ...
    // Calcoliamo i punteggi in base alle risposte date dall'utente
    if (risposte[0] === 'si') {
      punteggi["Labrador"] += 1;
    } else {
      punteggi["Soriano"] += 1;
    ...
    // Troviamo la razza con il punteggio più alto
    let razzaMigliore = '';
